              ...
              <div className={`${styles.project_body}`}>
                <div className={`${styles.project_description}`}>
                  <p>
                    ...
                    euismod, nisl ut luctus aliquet, sem mi ultricies lacus,
                    vitae bibendum est dui in diam.
                  </p>
                </div>
              </div>
            </div>
          ...
          >
            ...
            >
              ...
              <div className={`${styles.project_body}`}>
                <div className={`${styles.project_description}`}>
                  <p>
                    A set of modular career hubs that provide students and young
                    adults with tools to explore career options in their local
                    communities. Each hub comes with a custom-tailored pathways
                    experience that begins with a short quiz.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className={`${styles.projects_body_child}`} id="Leader Profiles">
            ...
            >
              ...
              <div className={`${styles.project_body}`}>
                <div className={`${styles.project_description}`}>
                  <p>
                    At Roadtrip Nation, we&apos;ve built an archive of over
                    8,000 interviews with unique leaders across the US, each
                    detailing a one of a kind career journey. I spearheaded
                    implementation of a new, modern, design that showcases these
                    leaders.
                  </p>
                </div>
              </div>
          ...
          <div className={`${styles.projects_body_child}`} id="rtne">
            ...
            >
              ...
              >
                <div className={`${styles.project_description}`}>
                  <p>
                    An in-depth, classroom-based immersive for students and
                    educators. This course guides students through a reflection
                    on their own skills and connects those with career options
                    and real-world stories from the Roadtrip Nation interview
                    archive.
                  </p>
                </div>
              </div>
            ...
            <div className={`${styles.project} ${styles.project_non_grid}`}>
              ...
              <div className={`${styles.project_body}`}>
                ...
                <div className={`${styles.project_description}`}>
                  ...
                  <p>
                    Based on <i>The Black Hack</i> and made with <i>Nextra</i>.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className={`${styles.projects_body_child}`} id="Pong">
            <div className={`${styles.project} ${styles.project_non_grid}`}>
              ...
              <div className={`${styles.project_body}`}>
                ...
                <div className={`${styles.project_description}`}>
                  <p>
                    Simple game of Pong, complete with music. Downloadable on
                    MacOS.
                  </p>
                </div>
              </div>
          ...
          <div className={`${styles.projects_body_child}`} id="Poemverse">
            <div className={`${styles.project} ${styles.project_non_grid}`}>
              ...
              <div className={`${styles.project_body}`}>
                ...
                <div className={`${styles.project_description}`}>
                  <p>
                    Full-stack poetry anthology builder using poems sources from
                    the <i>PoetryDB</i> api.
                  </p>
          ...
          <div className={`${styles.projects_body_child}`} id="BirbWatcher">
            <div className={`${styles.project} ${styles.project_non_grid}`}>
              ...
              <div className={`${styles.project_body}`}>
                ...
                <div className={`${styles.project_description}`}>
                  <p>
                    Personal bird watching log with bird taxonomy and species
                    detail sourced from Ebird.
                  </p>
                </div>
              </div>
            </div>
